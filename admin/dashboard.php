                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                        <div class="dash-widget">
							...
							<div class="dash-widget-info text-right">
								...
								<span class="widget-title1">Employé(e)s <i class="fa fa-check" aria-hidden="true"></i></span>
							</div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                ...
                                <span class="widget-title2">Départements <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-4">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                ...
                                <span class="widget-title3">Temps de travail <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
                       ...
                       <div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Employé(e)s </h4> <a href="employees.php" class="btn btn-primary float-right">View all</a>
							</div>
					  ...
					  <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="card member-panel">
							<div class="card-header bg-white">
								<h4 class="card-title mb-0">Département d'employé(e)</h4>
							</div>
                            <div class="card-body">
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="employees.php" class="text-muted">Voir tous les employés</a>
                            </div>
                        </div>
                    </div>
				</div>
