...
?>
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 ">
                        <h4 class="page-title">Modifier département</h4>
                    </div>
                    <div class="col-sm-8  text-right m-b-20">
                        <a href="departments.php" class="btn btn-primary btn-rounded float-right">Annuler</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="post">
                          <div class="form-group">
                                <label>Identifiant du département</label>
                            ...
                            <div class="form-group">
                                <label class="display-block">Status de département</label>
