...
?>
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 ">
                        <h4 class="page-title">Modifier temps de travail</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form method="post" >
                            ...
                            <div class="form-group">
                                <label class="display-block">Status du temps de travail</label>
                            ...
                            <div class="m-t-20 text-center">
                                <button name="save-shift" class="btn btn-primary submit-btn">Sauvegarder</button>
                            </div>
                        </form>
                    </div>
                </div>
