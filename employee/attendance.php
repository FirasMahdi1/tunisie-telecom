...
else
{
  $outtime = "Early";
    ...
    if(isset($_REQUEST['turn-it']))
    {
      ...
      $insert_query = mysqli_query($connection, "insert into tbl_attendance set employee_id='$emp_id', department='$department', shift='$shift', poste='$poste', message='$msg', date='$date',  check_in='$check_in', in_status='$in_status'");
...
?>
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 ">
                        <h4 class="page-title">Formulaire de présence</h4>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                       <form method="post">
                            <div class="row">
                              <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Temps de travail <span class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="poste" required>
                                            <option value="">Select</option>
                                            <?php
                                             $fetch_query = mysqli_query($connection, "select poste from tbl_location");
                                                while($loc = mysqli_fetch_array($fetch_query)){ 
                                            ?>
                                            <option value="<?php echo $loc['poste']; ?>"><?php echo $loc['poste']; ?></option>
                                            <?php } ?>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="turn-it"><img src="../assets/img/login.png" width="40">Envoyer</button>
                            </div>
                        </form>
                    </div>
                  <?php } else {
                   ...
                   <div class="col-lg-12 offset-lg-2">
                       <div class="row">
                              <div class="col-sm-6">
                    <center><h3>Merci pour aujourd'hui</h3></center>
                    <form method="post">
                     <div class="m-t-20 text-center">
                      <?php
                      $curr_date = date('Y-m-d');
                      ...
                      ?>
                                <button class="btn btn-primary submit-btn" name="check-out" onclick="return confirmDelete()"><img src="../assets/img/login.png" width="40">Vérifier!</button>
                      <?php  } else{?>
                        <button disabled class="btn btn-primary submit-btn" name="check-out" onclick="return confirmDelete()"><img src="../assets/img/login.png" width="40">  Fait!</button>
                        <h5>À demain!</h5>
                      <?php } ?>
